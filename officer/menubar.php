						...
						?>
                            <span class="pull-right">
                               <?php echo $row['surname']." ". $row['othernames']." (" .$row['staffid'].")";  ?> 
                                  ...
                                  <a href="profile.php" class="btn btn-primary"><i class="icon-signout icon-large "></i>&nbsp;Edit</a><a href="logout.php" class="btn btn-primary"><i class="icon-signout icon-large "></i>&nbsp;Logout</a>
                                  </span>
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h3 class="panel-title"> <a href="caseview.php">
									<span class="glyphicon glyphicon-user" aria-hidden="true"></span> View Patients</a>
							</div>
